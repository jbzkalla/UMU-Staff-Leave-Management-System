...
if(isset($_POST['login'])){
    ...
    if(!$errors){
            ...
            if(password_verify($password, $rows->password)){
               ...
               session_start();
                ...
                if($login_type == "hr_admin"){
                    ...
                    // SECURITY: Ensure staff are approved before login
                    if($rows->staff_level == "" || is_null($rows->staff_level)){
                        $error = urlencode("Your account is awaiting HR Admin approval. Please try again later.");
        ...
        header("Location:index.php?error=".implode("<br>", $errors));
