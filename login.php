...
if(isset($_GET['action']) && $_GET['action'] == "login"){
    ...
    if(isset($_GET['type']) && $_GET['type'] == "admin"){
        ...
        $username = "username";
        $action = "user.php?type=hr_admin";
        $id = "hr-admin-login";
        $field = "HR Admin Username";
        $prop = 'text';
        $login_type = "hr_admin";
        ...
        $account_trigger = "New staff? <a href='register.php' class='text-sm'>"
                . "Register now</a>";
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4 col-xl-4 mx-auto">
            <div class="text-center mb-4">
                <img src="images/logo(2).jpeg" alt="UMU Logo" style="height: 100px; display: block; margin: 0 auto;">
            </div>
...
echo $part;
        ...
        $last = <<<YOP
            ...
            <form action="user.php" method="post" id="$id">
                ...
                <label class="text-black" for="staff_user">$field</label><br>
                <input type="$prop" name="$username" maxlength="50" class="input-text" id="username" required><br>
