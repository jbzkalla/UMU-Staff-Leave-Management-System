...
<head>
<meta charset="utf-8"/>
<meta name="author" content="Leon SmartLeave - Uganda Martyrs University">
<title>Leon SmartLeave – UMU Staff Leave Management System</title>
...
<nav class="fixed-top navbar-expand-lg navbar-expand-xl navbar">
  ...
  <a class="navbar-brand mr-5" href="/LeaveManager">
    <img src="images/logo(2).jpeg" alt="Uganda Martyrs University Logo" style="height: 50px;">
    <span class="d-none d-md-inline ml-2" style="color: #fff; font-weight: bold;">Leon SmartLeave – UMU</span>
  </a>
...
POP;
        ...
        if(isset($_SESSION['staff-user']) && $_SESSION['staff-user'] != ''){
            ...
            $supervisor_username = $_SESSION['supervisor-user'];
