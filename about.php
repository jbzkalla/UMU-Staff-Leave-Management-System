...
<div class="container my-5">
    <div class="card col-md-8">
        <h1 class="text-center">Leon SmartLeave – UMU Staff Leave System</h1>
        <p>Leon SmartLeave is a web-based staff leave management system developed to automate leave application, approval, and reporting processes at Uganda Martyrs University (UMU). This system is designed to provide a professional institutional experience for UMU Staff, Supervisors, and HR Administrators.</p>
        
        <p>The system supports three distinct user roles: Staff Members, Departmental Supervisors, and HR Administrators. Each role has specific capabilities tailored to the university's human resource requirements.</p>
